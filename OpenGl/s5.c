//this iteration will be on how to pass additional vertex information to the vertex shader. 
...
//added two more references. the color ones.
...
void display() 
{
	...
	//again, most of these are duplicates of the stuff above so you should have an idea of 
	//how it all works. go back to the commentary on that section if anything confuses you.
	//also, there is a line added to the vertex shader as a result of this. be sure to check
	//that out as this is only part of the changes.
	glutSwapBuffers();
}
